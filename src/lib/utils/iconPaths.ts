...
export function getIconPath(icon: NodeIcon | undefined): string {
  switch (icon) {
    ...
    case 'building': return 'M3 21h18 M5 21V7l8-4v18 M19 21V11l-6-4 M9 9v0 M9 13v0 M9 17v0 M13 9v0 M13 13v0 M13 17v0';
    ...
    case 'database': return 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z';
